...
function checkRezervedBook($link,$id,$id_perdoruesi){
...
function checkTakenBook($link,$id,$id_perdoruesi){
...
function shtoPrenotim($link,$id){
	...
	$status_rezervuar = checkRezervedBook($link,$id_libri,$id_perdoruesi );
	
	$status_marre = checkTakenBook($link,$id_libri,$id_perdoruesi );
