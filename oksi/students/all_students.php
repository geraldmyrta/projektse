...
$link = mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD);
	...
	if(!$db) {
	  ...
	  $query = "SELECT * FROM perdoruesi WHERE niveli = 'student' LIMIT 0, 10";
		...
		<script type="text/javascript" >
		 $(function() {
			 $('.t').click(function(e) {
                ...
                var fshi_id = $(this).attr('id');
				var r = confirm("Doni te fshini te gjitha te dhenat per kete student?");
				if(r==true){
				$.ajax({
										url: 'admin/students/actions/student_actions_get.php',
										type: 'POST',
										dataType: 'json',
										data: { "action": "DELETE",
												"id":fshi_id
	...
	<script type="text/javascript">
	 ...
	 $(document).ready(function ()
        {	
			...
			$('#computing_area_id').load("admin/students/search_student.php?search="+search);
 ...
 <?php 
	 ...
	 $id = $row[$col_id];
	  ...
	  echo "<div    class = 'box_area' >
				...
				echo "<td> <input type='button' class = 't' id = '$id' value = 'Fshi'/> </td>
