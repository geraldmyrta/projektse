...
$data = $id;
if(mysqli_query($link," DELETE FROM libri WHERE id = $data"))
 if(mysqli_query($link,"DELETE FROM huazo WHERE id_libri = $data"))
   if(mysqli_query($link,"DELETE FROM prenoto WHERE id_libri = $data"))
	return 1;
else
	return 0;
}
